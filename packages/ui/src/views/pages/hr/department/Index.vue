<template>
  <h-row gutter="md" gutter-col horizontal>
    ...
    <h-column lg="10" md="10" sm="6" xs="12">
      ...
      >
        <template #top-left>
          <h-button :disable="!organizationId" color="primary" label="新建部门" @click="toCreate(additionalData)" />
        </template>
...
defineOptions({
  ...
  components: { HDeleteButton, HDictionarySelect, HEditButton, HOrganizationSelect, HTable, HOrganizationTree },
});
