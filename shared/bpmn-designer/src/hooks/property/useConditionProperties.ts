...
export default function useConditionProperties() {
  ...
  const setConditionExpressionValue = (element: Element, value: string | number | null | undefined): void => {
  ...
  const setFormatValue = (element: Element, value: string | number | null | undefined): void => {
    const conditionExpression = fetchConditionExpression(element, true);
  ...
  const setResourceValue = (element: Element, value: string | number | null | undefined): void => {
    const conditionExpression = fetchConditionExpression(element, true);
  ...
  const setScriptValue = (element: Element, value: string | number | null | undefined): void => {
    const conditionExpression = fetchConditionExpression(element, true);
    getModeling().updateModdleProperties(element, conditionExpression, { body: value });
  };
